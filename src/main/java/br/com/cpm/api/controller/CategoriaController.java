...
public class CategoriaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Categoria> atualizarCategoria(@PathVariable("id") Long id, @RequestBody Categoria dadosCategoria) {
        Optional<Categoria> categoria = categoriaService.carregarDadosCategoriaPeloId(id);
        ...
        dadosCategoria.setId(id);

        return ResponseEntity.ok().body(categoriaService.salvarCategoria(dadosCategoria));
    }
